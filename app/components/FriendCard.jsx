...
export class FriendCard extends React.Component {
    render() {
        ...
        return (
            <div>
                <a href={"#/tab/" + _id} className="btn btn-sm btn-info custom-btn" title={name}>
                    <img
                    ...
                    <div className="visible-lg visible-md visible-sm">
                        <h4 className="custom-name-top">{formattedName[0]}</h4><h4
                        className="custom-name">{formattedName[1]}</h4>
                    </div>
                </a>
            </div>
        );
